...
$app->register(Modules\User\Providers\UserServiceProvider::class);
$app->register(Modules\Transaction\Providers\TransactionServiceProvider::class);
$app->register(App\Providers\ExecuteServiceProvider::class);
...
$app->alias('ExecuteService', App\Facades\ExecuteService::class);
